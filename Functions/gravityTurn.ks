Function gravityTurn {
  Parameter targetAltitude, polarOrbit is 0.
  ...
  If polarOrbit = 1 {
    Lock desiredHeading to heading(0,desiredPitch) + R(0,0,270).
  } Else {
  ...
  Until switchOver {
    ...
    If body:atm:altitudePressure(altitude) < 0.001 { Set switchOver to true. }.
